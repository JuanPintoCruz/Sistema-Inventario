...
include("../../sesion.php");
    ...
    $sentencia = $conexion->prepare("SELECT * FROM `tbl_bannerdos`");
    $sentencia->execute();
    ...
    if(isset($_GET['txtID'])) {
      ...
      $sentencia = $conexion->prepare("DELETE FROM tbl_bannerdos WHERE id = :id");
      $sentencia->bindParam(":id", $txtID);
      $sentencia->execute();
  ...
  <!-- Content Header (Page header) -->
        ...
        <div class="row align-items-center">
          <div class="col-md-4 text-start">
              <a href="crear2.php" class="btn btn-success mb-3" type="button" style="border-radius: 10px;">
                <img2 src="<?php echo $url_base;?>assets/img2/cliente/agregar-cliente.png" alt="agregar" style="width: 18px; height: 18px;"> Agregar Nuevo
              </a>
          </div>
      ...
      <div class="col">
        <div class="table-responsive">
          ...
          <table class="table">
            ...
            <tbody>
            <?php foreach($lista_tbl_bannerdos as $registro){?>
              <tr>
                <td><?php echo $registro['id'];?></td>
                <td><img src="./img2/<?php echo htmlspecialchars($registro["foto_portada"]); ?>" width="80px" height="80px" /> </td>
                <td><?php echo $registro['titulo'];?></td>
                <td><?php echo $registro['descripcion'];?></td>
                <td>
                <a name="" id="" class="btn btn-info" href="modificar2.php?txtID=<?php echo $registro['id']; ?>"role="button">M</a>
...
<script>
 function borrar(id){
  ...
  if (result.isConfirmed) {
    window.location="banner2.php?txtID="+id;
  }
});
 }
</script>
