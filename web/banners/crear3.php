...
if($_POST){
    ...
    $sentencia = $conexion->prepare("INSERT INTO `tbl_bannertres` 
    ...
    if ($tmp_foto != '') {
        move_uploaded_file($tmp_foto, "./img3/" . $nombreArchivo_foto);
    }
...
$sentencia_bannertres = $conexion->prepare("SELECT * FROM `tbl_bannertres`");
$sentencia_bannertres->execute();
$lista_tbl_bannertres = $sentencia_bannertres->fetchAll(PDO::FETCH_ASSOC);
?>
